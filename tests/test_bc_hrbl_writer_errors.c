...
int main(void)
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(test_last_error_initial_state_ok),
        cmocka_unit_test(test_last_error_unclosed_scope),
        cmocka_unit_test(test_last_error_construction_invalid_scope),
        cmocka_unit_test(test_last_error_ok_after_successful_finalize),
    };
